...
Component({
  ...
  methods: {
    ...
    tapDayItem(e) {
      ...
      var zero = 0;
      //var Day = 0; 
      var select = this.data.calendar.selectedDay[0];
      var day = select.day;
      var mon = select.month;
      var year = select.year;
      if (mon < 10) {
        var mon = '0'+select.month;
      } 
      if (day < 10) {
        var day = '0' + select.day;
      }
